...
`htmlwidgets` allow you to create **isolated** visualisations, with Shiny you can build highly interactive web applications including inter-dependent visualiations and pull-down menus.
...
When a Shiny app is running on your local machine a web-server allows you to interact with the application - to deploy Shiny apps to the web you need to have Shiny Server running somewhere.
...
## shinyapps.io: Comments on active hours

Apps can quickly become popular, but not as popular as you might fear. If you do want to pay for an account, always start small.

The Interactive Data Network is paying for a Professional tier and has not gone over 500 active hours in a single month.

The most popular app we've published is for the Online Labour Index which was covered in the Guardian and a few other news sources, but only racked up 106 active hours during that time.

<a href="http://ilabour.oii.ox.ac.uk/online-labour-index/"><img src="images/online_labour_index.png" width = "100%" alt = Beamer/></a>
