...
Plotly is an excellent tool for creating interactive charts, plots and other visualisations. The underlying JavaScript library is called plotly.js, it's also useful to know that it's developers provide a point-and-click service for building charts at [plot.ly](plot.ly).
...
continent_mean_pop_growth %>%
  ...
  layout(xaxis = list(title = "Year"),
         yaxis = list(title = "Mean Population of Continent"),
         title = "Mean population of continents over time (source: Gapminder)")
```
