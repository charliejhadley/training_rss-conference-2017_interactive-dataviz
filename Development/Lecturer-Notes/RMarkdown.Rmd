...
Provided that your RMarkdown document is a HTML document, it's fairly easy to include htmlwidgets in your documents.

However, there are some pitfalls. A fairly annoying one concerns leaflet maps, below is a fairly
