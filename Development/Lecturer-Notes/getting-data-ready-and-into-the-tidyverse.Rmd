...
Before we address the warning messages from our verb, let's ensure recap the pipe operator.
...
To learn more I'll re-recommend the resources I've mentioned previously:
